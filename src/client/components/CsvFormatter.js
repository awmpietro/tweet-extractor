...
const CsvFormatter = ({ results }) => {
  const renderHeader = () => {
    const headers = [
      ...
      {
        label: 'metadata_iso_language_code',
        key: 'metadata.iso_language_code',
      },
      ...
      {
        label: 'user_is_translation_enabled',
        key: 'user.is_translation_enabled',
      },
      {
        label: 'user_profile_background_color',
        key: 'user.profile_background_color',
      },
      {
        label: 'user_profile_background_image_url',
        key: 'user.profile_background_image_url',
      },
      {
        label: 'user_profile_background_image_url_https',
        key: 'user.profile_background_image_url_https',
      },
      {
        label: 'user_profile_background_tile',
        key: 'user.profile_background_tile',
      },
      { label: 'user_profile_image_url', key: 'user.profile_image_url' },
      {
        label: 'user_profile_image_url_https',
        key: 'user.profile_image_url_https',
      },
      { label: 'user_profile_banner_url', key: 'user.profile_banner_url' },
      { label: 'user_profile_link_color', key: 'user.profile_link_color' },
      {
        label: 'user_profile_sidebar_border_color',
        key: 'user.profile_sidebar_border_color',
      },
      {
        label: 'user_profile_sidebar_fill_color',
        key: 'user.profile_sidebar_fill_color',
      },
      { label: 'user_profile_text_color', key: 'user.profile_text_color' },
      {
        label: 'user_profile_use_background_image',
        key: 'user.profile_use_background_image',
      },
      { label: 'user_has_extended_profile', key: 'user.has_extended_profile' },
      { label: 'user_default_profile', key: 'user.default_profile' },
      {
        label: 'user_default_profile_image',
        key: 'user.default_profile_image',
      },
